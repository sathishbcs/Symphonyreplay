...
Confirm Queue
    ...
    Sleep    2
    Take Screenshot    018_User_defined.jpg
    ...
    Take Screenshot    19_Confirmed_queue.jpg
    #Status check: No queue has been defined
    CustomSapGuiLibrary.No Queue Pending    ${no_Queue_id}
    Take Screenshot    20_Status_Confirmed_queue1.jpg
    #Click DoNOTSEND
    CustomSapGuiLibrary.Click Element   wnd[1]/tbar[0]/btn[27]
    Take Screenshot    21_Status_Confirmed_queue2.jpg
