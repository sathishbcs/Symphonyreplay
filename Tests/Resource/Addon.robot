...
Saint Transation Code
    ...
    Sleep    2
    CustomSapGuiLibrary.Take Screenshot    01_saintfrontpage.jpg
    Sleep    1
    CustomSapGuiLibrary.get maintenance certificate text    ${certificate_id}    
    CustomSapGuiLibrary.Take Screenshot    02_certificate.jpg
    Sleep   5
    ...
    Sleep    10
    CustomSapGuiLibrary.Take Screenshot    03_Saint1.jpg
   
    CustomSapGuiLibrary.Click Element    wnd[0]/usr/btnBUTTON_NEXT
    Sleep    2    
    CustomSapGuiLibrary.Take Screenshot    04_saint2.jpg
...
Get Cell Text From SAP Table
    ...
    Sleep    2
    Take Screenshot    05_select_addon.jpg
...
Important SAP note handling
    ...
    Sleep    2
    Take Screenshot    11_SAPhandling.jpg
 
Start Options 
    Click Element    wnd[1]/tbar[0]/btn[27] 
    Sleep    2
    Take Screenshot    12_start options_prep.jpg
    ...
    Sleep   2
    Take Screenshot    13_prepration_dialog.jpg
    CustomSapGuiLibrary.Click Element    wnd[1]/usr/tabsSTART_OPTIONS/tabpSTART_FC2
    Sleep   2
    Take Screenshot    14_select_import_1.jpg
    ...
    Sleep   2
    Take Screenshot    15_import_bkgd.jpg
 
Import Option
    CustomSapGuiLibrary.Click Element    wnd[1]/tbar[0]/btn[0]
    Sleep   1
    Take Screenshot    16_start options selected.jpg    
    CustomSapGuiLibrary.Click Element    wnd[1]/tbar[0]/btn[25]
    Take Screenshot    17_import2.jpg
    Sleep    3
...
Process Until Finish Button Visible  
    ...
    Sleep    2
    Click Element    wnd[1]/tbar[0]/btn[27]
    Take Screenshot    20_Addon_import2.jpg    
